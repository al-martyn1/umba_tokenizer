/*! \file
    \brief Константы классов символов. При помощи классов символов можно просто писать простейшие лексера. Уложены в 16 бит для компактности для встраиваемых применений.
 */
#pragma once
