...
makeTokenizerBuilderUSketch()
{
    ...
    addMultiLenOperator("-\\", true , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_TOP     , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_TOP_LAST    );
    addMultiLenOperator("-/" , true , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_BOTTOM  , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_BOTTOM_LAST );
    addMultiLenOperator("/-" , false, USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_TOP    , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_TOP_LAST   );
    addMultiLenOperator("\\-", false, USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_BOTTOM , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_BOTTOM_LAST);
    addMultiLenOperator("<-" , false, USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT         , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_LAST        );
    addMultiLenOperator("->" , true , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT        , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_LAST       );
    addMultiLenOperator("^-" , false, USKETCH_TOKEN_OPERATOR_CALLOUT_TO_TOP          , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_TOP_LAST         );
    addMultiLenOperator("|-" , false, USKETCH_TOKEN_OPERATOR_CALLOUT_TO_BOTTOM       , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_BOTTOM_LAST      );
    addMultiLenOperator("-"  , false, USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF           , USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF_LAST          );
    //addMultiLenOperator("-." , true , USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF_TO_LEFT   , USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF_TO_LEFT_LAST  );
...
//----------------------------------------------------------------------------
struct USketchTokenizerConfigurator
{
    template<typename TokenizerType>
    TokenizerType operator()(TokenizerType tokenizer)
    {
    
        using tokenizer_type = TokenizerType; // typename TokenizerBuilder::tokenizer_type;
        ...
        tokenizer.template installTokenFilter<KebabCaseComposingFilter>(UMBA_TOKENIZER_TOKEN_OPERATOR_SUBTRACTION);

        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_TOP     , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_TOP_LAST    );
        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_BOTTOM  , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_BOTTOM_LAST );
        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_TOP    , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_TOP_LAST   );
        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_BOTTOM , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_BOTTOM_LAST);
        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT         , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_LEFT_LAST        );
        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT        , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_RIGHT_LAST       );
        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_TO_TOP          , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_TOP_LAST         );
        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_TO_BOTTOM       , USKETCH_TOKEN_OPERATOR_CALLOUT_TO_BOTTOM_LAST      );
        //addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF_TO_RIGHT  , USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF_TO_RIGHT_LAST );
        //addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF_TO_LEFT   , USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF_TO_LEFT_LAST  );
        addMultiLenOperatorFilter(USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF, USKETCH_TOKEN_OPERATOR_CALLOUT_SHELF_LAST);
...
typename TokenizerBuilder::tokenizer_type makeTokenizerUSketch(TokenizerBuilder builder, TokenHandler tokenHandler, bool suffixGluing=true, bool preprocessorFilter=true)
{
    ...
    return USketchTokenizerConfigurator()(tokenizer);
}
