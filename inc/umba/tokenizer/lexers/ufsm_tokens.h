/*! \file
    \brief Константы токенов для лексера (сканера) диаграмм UmbaFSM
 */
/*! \file
...
#define UFSM_TOKEN_KWD_DEFINITIONS               ((UFSM_TOKEN_SET_KEYWORDS)+0x0012)
#define UFSM_TOKEN_KWD_ALL                       ((UFSM_TOKEN_SET_KEYWORDS)+0x0013)
#define UFSM_TOKEN_KWD_USES                      ((UFSM_TOKEN_SET_KEYWORDS)+0x0014)
#define UFSM_TOKEN_KWD_OVERRIDE                  ((UFSM_TOKEN_SET_KEYWORDS)+0x0015)
...
#define UFSM_TOKEN_OP_NOT                        UMBA_TOKENIZER_TOKEN_OPERATOR_LOGICAL_NOT
#define UFSM_TOKEN_OP_AND                        UMBA_TOKENIZER_TOKEN_OPERATOR_LOGICAL_AND
#define UFSM_TOKEN_OP_OR                         UMBA_TOKENIZER_TOKEN_OPERATOR_LOGICAL_OR 
#define UFSM_TOKEN_OP_NOT_ALTER                  UMBA_TOKENIZER_TOKEN_OPERATOR_BITWISE_NOT
#define UFSM_TOKEN_OP_AND_ALTER                  UMBA_TOKENIZER_TOKEN_OPERATOR_BITWISE_AND
#define UFSM_TOKEN_OP_OR_ALTER                   UMBA_TOKENIZER_TOKEN_OPERATOR_BITWISE_OR 
...
#define UFSM_TOKEN_BRACKET_SCOPE_OPEN            UMBA_TOKENIZER_TOKEN_CURLY_BRACKET_OPEN 
#define UFSM_TOKEN_BRACKET_SCOPE_CLOSE           UMBA_TOKENIZER_TOKEN_CURLY_BRACKET_CLOSE
