- [Скалярные типы protobuf](#скалярные-типы-protobuf)

# Скалярные типы protobuf
...
|**bytes**|May contain any arbitrary sequence of bytes no longer than 232. </cmt-val-list>|
